...
export function CinematicHero({ kicker, title, subtitle, ctaLabel, ctaHref }: CinematicHeroProps) {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.to("[data-hero-item='kicker']", { opacity: 1, y: 0, duration: 0.7 })
        .to("[data-hero-item='title']", { opacity: 1, y: 0, duration: 0.9 }, "<0.1")
        .to("[data-hero-line]", { scaleX: 1, duration: 0.8 }, "<0.05")
        .to("[data-hero-item='subtitle']", { opacity: 1, y: 0, duration: 0.75 }, "<0.15")
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col gap-8">
        <p data-hero-item="kicker" className="text-xs uppercase tracking-[0.24em] text-black/60">
          {kicker}
        </p>
